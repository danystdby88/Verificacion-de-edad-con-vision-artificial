...
📊 Datos
- Conjunto de fotografías de personas con sus edades reales
- Imágenes de rostros utilizadas para entrenar el modelo de visión artificial
💻 Herramientas Técnicas
- Jupyter Notebook — Documentación completa del proceso
- Plataforma GPU — Entrenamiento del modelo (requerido por la carga computacional)
- Redes Neuronales — Predicción de edad a partir de imágenes
